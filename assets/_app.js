var appProductes = angular.module("appProductes", ['ngResource']);


appProductes.controller("ProductesController", function ($scope, ProductesSvc) {
    $scope.productes = [];
...
//Creo el servei per poder utilitzar PUT amb ng-Resource.
appProductes.service('ProductesSvc', function ($resource) {
